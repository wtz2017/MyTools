...
public class SearchView extends View {
    ...
    private void startSearch() {
        ...
        Log.d(TAG, "to start mStartingAnimator");
            ...
            public void handleMessage(Message msg) {
                ...
                switch (mCurrentState) {
                    case STARTING:
                        ...
                        Log.d(TAG, "to start mSearchingAnimator");
                        mSearchingAnimator.start();
                        break;
                    case SEARCHING:
                        if (!isOver) {  // 如果搜索未结束 则继续执行搜索动画
                            Log.d(TAG, "to re-start mSearchingAnimator");
                            mSearchingAnimator.start();
                            ...
                            Log.d(TAG, "to start mEndingAnimator");
        ...
        switch (mCurrentState) {
            ...
            case STARTING:
                ...
                if (Build.VERSION.SDK_INT <= 19) {
                    ...
                    // A simple workaround is to add a single operation to this path, such asdst.rLineTo(0, 0).
                    dst.rLineTo(0, 0);
                }
