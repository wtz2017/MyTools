package com.wtz.tools.view.recycler_item_decoration;
...
public class StickySectionDecoration extends RecyclerView.ItemDecoration {
    ...
    public StickySectionDecoration(Context context, GroupInfoCallback callback) {
        ...
        mDividerHeight = context.getResources().getDimensionPixelOffset(R.dimen.dp_2);
        mHeaderHeight = context.getResources().getDimensionPixelOffset(R.dimen.dp_24);
        mTextSize = context.getResources().getDimensionPixelOffset(R.dimen.sp_22);
