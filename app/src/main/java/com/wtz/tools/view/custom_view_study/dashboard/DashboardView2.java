...
public class DashboardView2 extends View {
    ...
    private void init() {
        ...
        mBgColors = new int[]{
                ...
                mContext.getResources().getColor(R.color.dashboard_color_orange),
                mContext.getResources().getColor(R.color.dashboard_color_yellow),
                mContext.getResources().getColor(R.color.dashboard_color_green),
                mContext.getResources().getColor(R.color.dashboard_color_blue)};
        myBackgroundColor = mBgColors[0];
    }
    ...
    public void setCreditValueWithAnim(int creditValue) {
        ...
        creditValueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                mCreditValue = (Integer) animation.getAnimatedValue();
                postInvalidate();
            }
        });
        ...
        ObjectAnimator colorAnimator = ObjectAnimator.ofInt(this, "myBackgroundColor", mBgColors[0], mBgColors[0]);
        // 实时信用值对应的背景色的变化
        long delay = 1000;
        if (mSolidCreditValue > 700) {
        ...
        colorAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator animation) {
                myBackgroundColor = (Integer) animation.getAnimatedValue();
            }
        });
